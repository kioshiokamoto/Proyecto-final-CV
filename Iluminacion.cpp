...
void lighting::install_Lights(/*QMatrix4x4 vMatrix*/){
    currentLightPos = QVector3D(/*vMatrix**/QVector4D(lightLoc,1.0));
    /*transformed = QVector3D(vMatrix*QVector4D(currentLightPos,1.0));
    lightPos = transformed;*/
}
